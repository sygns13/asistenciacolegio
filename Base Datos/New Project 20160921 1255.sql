...
INSERT INTO `configpago` (`idConfig`,`matricula`,`mensualidad`,`fecini`,`fecfin`,`estado`) VALUES 
 (1,'300.00','180.00','2016-01-01','2016-01-01','Activo');
/*!40000 ALTER TABLE `configpago` ENABLE KEYS */;


--
-- Definition of table `descuentorecargo`
--

DROP TABLE IF EXISTS `descuentorecargo`;
CREATE TABLE `descuentorecargo` (
  `idDescRec` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(200) DEFAULT NULL,
  `descuento` decimal(12,2) DEFAULT NULL,
  `tipo` int(11) DEFAULT NULL,
  `tipo2` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idDescRec`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `descuentorecargo`
--

/*!40000 ALTER TABLE `descuentorecargo` DISABLE KEYS */;
/*!40000 ALTER TABLE `descuentorecargo` ENABLE KEYS */;
...
CREATE TABLE `pagorealizado` (
  ...
  CONSTRAINT `fk_PagoRealizado_Descuento1` FOREIGN KEY (`idDescRec`) REFERENCES `descuentorecargo` (`idDescRec`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
