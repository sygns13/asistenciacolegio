...
<html lang="es">
<head>
    <title>Alumnos que no Asistieron Hoy</title>
    <meta charset="utf-8">
...
<script>
     $(document).ready(function() { 
        ...
        $("#btnGuardar").click(function(e){
            ...
            $.post("../Funciones/ajax.php",{modulo:7,accion:3, v1:idper, v2:Usu, v3:motivo, v4:Alu, v5:Dni, v6:Grado, v7:Sec},function(data1){
...
function justificar(idper,nom,dni,grado,sec){
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li class="dropdown open" id="alerta1"><a data-hover="dropdown" onclick="rep1();" href="javascript:void(0);" class="dropdown-toggle" id="alertAlu"></a>
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">
                            Lista de Alumnos Inasistentes el Día de Hoy</div>
                            
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-user"></i>&nbsp;<a href="alertAlumnos.php">Inasistencias Alumnos</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="hidden"><a href="#">Inasistencias Alumnos</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">Inasistencias Alumnos</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
