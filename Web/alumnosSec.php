     ...
     $(document).ready(function() { 
        ...
        $("#btnGuardar").click(function(e){
           ...
           if(nom.length==0 || ape.length==0 || dni.length!=8){
            ...
            $.post("../Funciones/ajax.php",{modulo:0,accion:5,v1:nom,v2:ape,v3:dni,v4:dir,v5:telf,v6:mail,v7:sec},function(data1){
        ...
        $("#btnGuardarE").click(function(e){
           ...
           if(nom.length==0 || ape.length==0 || dni.length!=8){
            ...
            $.post("../Funciones/ajax.php",{modulo:0,accion:8,v:idP,v1:nom,v2:ape,v3:dni,v4:dir,v5:telf,v6:mail},function(data1){
        ...
        $("#pasarGrado").click(function(e){
          var item= new Array();
          var sec=$("#idSec").val();
                        
                         var cont=0;
                        $(jQuery("#idAlum:checked").each(function(){

                          var estado=$("#estMat"+$(this).val()).val();
                        ...
                        if (cont==0){
                          ...
                          swal('','Seleccione al menos un Alumno con estado no matriculado','info');
                            
                        }
                        else{
                        $.post("../Funciones/ajax.php",{modulo:0,accion:9,v:sec},function(data){
                          $("#grado").html(data);
                          $('#modal-config1').modal('show');
        ...
        $("#btnPasarG").click(function(e){
           var item1= new Array();

           var idNSec=$("#idNewSec").val();
          ...
          var cont1=0;
            ...
            cont1=cont1+1;
             ...
             if(idNSec>0){
               $.each(item1,function(index,contenido){
               $.post("../Funciones/ajax.php",{modulo:0,accion:10,v:contenido,v1:idNSec},function(data){
                         
                 
              });   
            });

            setTimeout("cerrarPasar();", 2000 );
             }

             if(idNSec==-1){
              $.each(item1,function(index,contenido){
                
               $.post("../Funciones/ajax.php",{modulo:0,accion:11,v:contenido},function(data){
                         
                 
              });   
            });

            setTimeout("cerrarPasar1();", 2000 );
             }
...
$("#matricular").click(function(e){
  ...
  var item= new Array();
    ...
    text: "Los alumnos seleccionados se matricularan en esta sección y ya no podrán pasar de Grado",  
     type: "warning",  
      ...
      //swal("Deleted!", "Your imaginary file has been deleted.", "success"); });
        ...
        $.each(item,function(index,contenido){
               ...
               $.post("../Funciones/ajax.php",{modulo:0,accion:12,v:contenido,v1:idsec},function(data){
                         
                 
              });   
            });

            setTimeout("cerrarPasar0();", 2000 );                   
     ...
     function LoadZero(){
        var idSe=jQuery("#idSec").val();
        $.ajax({
                        url: '../Funciones/Ajax.php',
                        type: 'POST',
                        data: {v1: idSe, modulo: '0', accion: '4'},
     ...
     function cerrarPasar1(){
      
      swal('','Los Alumnos Seleccionados Egresaron del Colegio, excepto, los que ya hayan sido pasados de año en este año escolar o los que hayan sido registrados en el presente año ecolar.','success');
      $('#modal-config1').modal('hide');
      LoadZero();
  
     }

     function cerrarPasar(){
      var idNSec=$("#idNewSec").val();
      swal('','Los Alumnos Seleccionados Pasaron de Año, excepto, los que ya hayan sido pasados de año en este año escolar o los que hayan sido registrados en el presente año ecolar.','success');
      $('#modal-config1').modal('hide');
      LoadZero();
      var win = window.open('alumnosSec.php?v1='+idNSec, '_blank');
      win.focus();
     }


     function cerrarPasar0(){
     
      swal('','Los Alumnos Seleccionados Se matricularon en esta sección para el presente de Año, excepto, los que ya hayan sido pasados de año en este año escolar o los que hayan sido registrados en el presente año ecolar.','success');
      $('#modal-config1').modal('hide');
      LoadZero();
  ...
  return ((key >= 48 && key <= 57) || (key==8) || (key==35) || (key==34) || (key==46));
     ...
     function delA(cod,nom) {
         swal({
  title: "¿Está seguro?",
  text: "Se eliminará al alumno(a): "+nom,
  type: "warning",
  showCancelButton: true,
...
function(){
  ...
  $.post("../Funciones/ajax.php",{modulo:0,accion:6,v1:cod},function(data1){

    var aux=parseInt(data1);

    if(aux==1){
      swal("", "No se puede eliminar al alumno(a) debido a que cuenta con Asistencias", "error");
    }
    if(aux==2){

      swal("Eliminado!", "El alumno(a) "+nom+" fue eliminado", "success");
        LoadZero();
    ...
    if(aux==3){
      swal("", "No se pudo eliminar al alumno(a) debido a un error en el sistema", "error");
    }
  });
  ...
  //swal("Deleted!", "Your imaginary file has been deleted.", "success");
     ...
     function editA(cod,nom){

        $.post("../Funciones/ajax.php",{modulo:0,accion:7,v1:cod},function(data1){
...
<body>
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">
                            ...
                            <?php
                            echo'<input type="hidden" readonly value="'.$idSec.'" id="idSec">';
                            ?>
                    </div>
                    ...
                    <div id="tab-general">
                        ...
                        <nav class="navbar navbar-inverse navbar-foxid" role="navigation">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <button type="button" class="btn btn-info btn-ms" id="matricular"> <i class="fa fa-check-square-o"></i> Matricular</button>
                                <button type="button" class="btn btn-green btn-ms" id="pasarGrado"> <i class="fa fa-upload"></i> Pasar de Grado</button>
                        ...
                        <div class="panel panel-default" id="PanewAlum">
                            <div class="panel-heading">Nuevos Alumnos</div>
   ...
   $sql0="select g.nombre,s.nombre
                        from seccion s
                        inner join grado g on g.idgrado=s.idgrado
                        where s.idseccion='".$idSec."';";

            $result0=mysql_query($sql0);

            while($row=mysql_fetch_array($result0)){

                echo'<div class="panel-heading">Grado: '.$row[0].'. Sección: '.$row[1].'</div>;';
            }
...
<tr>
  ...
  <div id="modal-config1" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" data-dismiss="modal" aria-hidden="true" class="close">
                                &times;</button>
                            <h4 class="modal-title" id="myModalLabel">
                                Pasar de Grado a los Alumnos:</h4>
                        </div>
                        <div class="modal-body">
                              <div class="field" id="grado">
        ...
        <input type="hidden" readonly value="0" id="idPer" >
                        ...
                        <div class="modal-footer">
                            <button type="button" data-dismiss="modal" class="btn btn-default">
                                ...
                                <button type="button" class="btn btn-primary" id="btnPasarG">
                                Pasar de Grado</button>
                        </div>
                    </div>
                </div>
            </div>
