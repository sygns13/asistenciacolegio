...
<script>
     $(document).ready(function() { 
        ...
        $("#btnAsist").click(function(e){
                ...
                if(dni.length<8){
                    swal('','Complete los 8 dígitos del DNI del docente','info');
                }
                else{
                    $.post("../Funciones/ajax.php",{modulo:3,accion:1,v:dni,v1:idUsu},function(data){
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                ...
                echo'<ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="controlSalida.php"><i class="fa fa-sign-out">
                        <div class="icon-bg bg-pink"></div>
                    </i><span class="menu-title">Control de Salidas</span></a>
                    </li>
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">
                            Módulo de Control de Salidas</div>
                            
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-sign-out"></i>&nbsp;<a href="controlSalida.php">Salidas</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="hidden"><a href="#">Salidas</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <div class="panel panel-default">
                            ...
                            <h3 align="center">Ingrese el DNI del alumno o docente para registrar su Salida</h3>  
