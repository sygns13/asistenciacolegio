     ...
     $(document).ready(function() { 
        ...
        $("#btnGuardar").click(function(e){
          ...
          var aux=0;
               ...
               $.post("../Funciones/ajax.php",{modulo:2,accion:1},function(data){

                aux=data; 

                if(aux==1){
                  swal('','Ya existe un Año Escolar aperturado para el presente Año','info');
                } 


                if(aux==0){
                  swal({   title: "¿Abrir un Nuevo Año Escolar?",   
                    text: "Aperturará un Nuevo Año Escolar, y se clausurará el año actual Vigente",   
                    type: "warning",   
                    showCancelButton: true,   
                    confirmButtonColor: "#00BFFF",   
                    confirmButtonText: "Si, Hacerlo",   
                    closeOnConfirm: false }, function(){   
                      $.post("../Funciones/ajax.php",{modulo:2,accion:2},function(data1){
                        LoadData();
                        //alert(data1);
                        swal("Exito", "Se Creo un Nuevo Año Escolar", "success"); });
      ...
      function LoadData(){
      var bus=$("#inputsearch").val();
        $.ajax({
                        url: '../Funciones/Ajax.php',
                        type: 'POST',
                        data: {search: bus, modulo: '2', accion: '0'},
            ...
            <div class="sidebar-collapse menu-scroll">
                ...
                echo'<ul id="side-menu" class="nav">
                  ...
                  if($_SESSION['nivelCR']==1 || $_SESSION['nivelCR']==2){
                    echo '<li class="active" ><a href="gesAescolar.php"><i class="fa fa-cogs">
                        <div class="icon-bg bg-green"></div>
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">
                            Módulo de Gestión de Años Escolares</div>
                            
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-cogs"></i>&nbsp;<a href="gesAescolar.php">Año Escolar</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="hidden"><a href="#">Año Escolar</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                    ...
                    <div id="tab-general">
                        ...
                        <nav class="navbar navbar-inverse navbar-foxid" role="navigation">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                <button type="button" class="btn btn-danger btn-ms" id="newAlum" style="display:none;"> <i class="fa fa-user-plus"></i> Cerrar Año Escolar</button>
                                <button type="button" class="btn btn-primary  btn-ms" id="btnGuardar" ><i class="fa fa-floppy-o"></i> Nuevo Año Escolar</button>
                                 <button type="button" class="btn btn-success  btn-ms" id="btnGuardar" style="display:none;"><i class="fa fa-floppy-o"></i> Editar Año Esclar</button>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                              ...
                              <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm"  id="inputsearch" value="" maxlength="45" placeholder="Año Escolar" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                 </div>
