...
<html lang="es">
<head>
    <title>Gestión de Conceptos Académicos</title>
    <meta charset="utf-8">
...
<script>
     $(document).ready(function() { 
        ...
        $("#btnGuardar").click(function(e){
           ...
           if(des.length==0 || ptos.length==0 || cod.length==0){
            swal('','Complete los datos del formulario','info');
           }
           else{

            $.post("../Funciones/ajax.php",{modulo:8,accion:6,v1:tipo,v2:des,v3:ptos,v4:cod},function(data1){
        ...
        $("#btnGuardarE").click(function(e){
           ...
           var idL=$("#idLis").val();
           if(des.length==0 || pto.length==0 || cod.length==0){
            swal('','Complete los datos del formulario','info');
           }
           else{

            $.post("../Funciones/ajax.php",{modulo:8,accion:3,v:idL,v1:des,v2:pto,v3:cod},function(data1){
      ...
      function LoadData(){
          ...
          var tipo=parseInt($("#cbtipo1").val());
      
        $.ajax({
                        url: '../Funciones/Ajax.php',
                        type: 'POST',
                        data: {v: tipo, modulo: '8', accion: '0'},
  ...
  return ((key >= 48 && key <= 57) || (key==8) || (key==35) || (key==34) || (key==46)|| (key==45)|| (key==9));
}

     function delC(id,nom,cod) {
         swal({
  title: "¿Está seguro?",
  text: "Se eliminará el Registro: "+nom+", Código: "+cod,
  type: "warning",
...
function(){
  ...
  $.post("../Funciones/ajax.php",{modulo:8,accion:2,v1:id},function(data1){

    var aux=parseInt(data1);

    if(aux==1){
      swal("", "No se puede eliminar el registro debido a que cuenta con Detalles", "error");
    }
    if(aux==2){
  ...
  //swal("Deleted!", "Your imaginary file has been deleted.", "success");
     ...
     function editC(id,nom,cod,pto,concep){


      $("#myModalLabel").text("Edición de "+concep);
      $("#txtdes").val(nom);
      $("#txtPto").val(pto);
      $("#txtcod").val(cod);
            ...
            <div class="sidebar-collapse menu-scroll">
                ...
                echo'<ul id="side-menu" class="nav">
                  ...
                  if($_SESSION['nivelCR']==1 || $_SESSION['nivelCR']==2){
                    ...
                    echo'<li class="active"><a href="gesConceptos.php"><i class="fa fa-check-square-o">
                        <div class="icon-bg bg-green"></div>
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">
                            Módulo de Gestión de Conceptos Académicos</div>
                            
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-check-square-o"></i>&nbsp;<a href="gesConceptos.php">C. Académicos</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="hidden"><a href="#">C. Académicos</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">C. Académicos</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                    ...
                    <div id="tab-general">
                        ...
                        <nav class="navbar navbar-inverse navbar-foxid" role="navigation">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                <button type="button" class="btn btn-primary btn-ms" id="newAlum"> <i class="fa fa-plus"></i> Nuevo</button>
                        ...
                        <div class="panel panel-default" id="PanewAlum">
                            <div class="panel-heading">Nuevo Concepto Académico</div>
                            <div class="panel-body">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                      <select id="cbtipo" class="form-control input-sm" autofocus  style="border: solid 1px;color: rgb(102, 101, 110);" >
                                        
                                        <?php

                                        $sql="select * from concepto where estado='activo';";
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm"  id="des" maxlength="250" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                                 <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Puntos:*</label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm"  id="ptos" maxlength="3" style="border: solid 1px;color: rgb(102, 101, 110);" onKeyPress="return soloNumeros(event);" >
                                    </div>
                                </div><br>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm"  id="cod" maxlength="10" style="border: solid 1px;color: rgb(102, 101, 110);" >
                                    </div>
                                </div><br>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-5">
                                      <select id="cbtipo1" class="form-control input-sm"   style="border: solid 1px;color: rgb(102, 101, 110);" >
                                         <?php
...
<table class="fila">
<tr>
    <td style="margin: 0 auto;text-align: left; width: 10%;">Descripción</td><td>:</td>
    <td ><input type="text" id="txtdes"  name="txtnom" value="" placeholder="" maxlength="250"  class="form-control" style="display:inline;"/></td>
</tr>

<tr>
    <td style="margin: 0 auto;text-align: left; width: 10%;">Puntos</td><td>:</td>
    <td><input type="text" id="txtPto"  name="txtape" value="" placeholder="" maxlength="5" class="form-control" style="display:inline;" onKeyPress="return soloNumeros(event);"/></td>
</tr>

<tr>
    <td style="margin: 0 auto;text-align: left; width: 10%;">Código</td><td>:</td>
    <td><input type="text" id="txtcod"  name="txtdni" value="" placeholder="" maxlength="10"class="form-control" style="display:inline;" /></td>
</tr>
        ...
        <input type="hidden" readonly value="0" id="idLis" >
