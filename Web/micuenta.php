     ...
     $(document).ready(function() { 
        ...
        $("#btnGuardar").click(function(e){
          ...
          //alert(idUsu);
           ...
           if(clave0.length==0){
            swal('','Completa la Contraseña Actual','info');
            $("#clave0").focus();
           }
           else if(clave1.length==0){
            swal('','Completa la Nueva Contraseña','info');
            $("#clave1").focus();
           }
           else if(clave2.length==0){
            swal('','Repita la Nueva Contraseña','info');
            $("#clave2").focus();
           }
           else if(clave1!=clave2){
            swal('','Las Nuevas Contraseñas deben de ser iguales','info');
            $("#clave1").focus();
           }
           else{

            $.post("../Funciones/ajax.php",{modulo:6,accion:0,v:idUsu,v1:clave0,v2:clave1,v3:clave2},function(data1){
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle"><img src="../images/avatar/48.jpg" alt="" class="img-responsive img-circle"/>&nbsp;<span class="hidden-xs"><?php echo $_SESSION['userCR']; ?></span>&nbsp;<span class="caret"></span></a>
                        <ul class="dropdown-menu dropdown-user pull-right">
                            <li class="active"><a href="micuenta.php"><i class="fa fa-user"></i>Mi Perfil</a></li>
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-user"></i>&nbsp;<a href="usuarios.php">Mi Perfil</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="hidden"><a href="#">Mi Perfil</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <?php
                                        ...
                                        $sql="select u.idusuario,u.nom,u.ape,u.dni,u.usuario, t.descripcion,t.idtipousu
                                                from usuario u
                                                inner join tipousuario t on t.idtipousu=u.idtipousu
                                                where u.idusuario='".$_SESSION['idCR']."';";
                                        ...
                                        $result = mysql_query($sql) or die("Error");
                                         while ($row = mysql_fetch_array($result)) {
                                            ...
                                            <input type="hidden" value="'.$row[6].'" id="idT">
                                            <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Nombres:</label>
                                    <div class="col-lg-5" id="inp">
                                        <input readonly type="text" class="form-control input-sm" disabled="true" value="'.$row[1].'" style="border: solid 1px;color: rgb(102, 101, 110);" id="nom" name="nom">
                                    </div>
                                </div><br><br>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5" id="inp">
                                        <input readonly type="text" class="form-control input-sm" disabled="true" value="'.$row[2].'" style="border: solid 1px;color: rgb(102, 101, 110);" id="ape" name="ape">
                                    </div>
                                </div><br><br>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5" id="inp">
                                        <input readonly  type="text" class="form-control input-sm" disabled="true" value="'.$row[3].'" style="border: solid 1px;color: rgb(102, 101, 110);" id="dni" name="dni">
                                    </div>
                                </div><br><br>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5" id="inp">
                                        <input readonly type="text" class="form-control input-sm" disabled="true" value="'.$row[4].'" style="border: solid 1px;color: rgb(102, 101, 110);" id="usu" name="usu">
                                    </div>
                                </div><br><br>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5" id="inp">
                                        <input readonly type="text" class="form-control input-sm" disabled="true" value="'.$row[5].'" style="border: solid 1px;color: rgb(102, 101, 110);" id="cat" name="nom">
                                    </div>
                                </div><br><br>
                                    ...
                                    <div class="col-lg-5" id="inp">
                                        <input type="password" class="form-control input-sm" style="border: solid 1px;color: rgb(102, 101, 110);" id="clave0" name="clave0">
                                    </div>
                                </div><br><br>
                                <div class="form-group form-group-sm">
