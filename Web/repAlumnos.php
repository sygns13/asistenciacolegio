...
$("#impRel").click(function(e){
    ...
    window.open('impAlumnos.php?v='+Grado+'&v1='+selFec+'&v2='+Asist+'&v3='+selSec+'&v4='+feci+'&v5='+fecf,' _blank');
});
...
$("#selGra").change(function() {
    ...
    if(Grado==0){
        ...
        $("#divsec").hide();
        $.post("../Funciones/Ajax.php",{modulo:4,accion:4,v:Grado,v1:selFec,v2:Asist,v3:0,v4:feci,v5:fecf},function(data1){
                $('#list').html(data1);
        });
...
$("#selSec").change(function() {
    ...
    $.post("../Funciones/Ajax.php",{modulo:4,accion:4,v:Grado,v1:selFec,v2:Asist,v3:selSec,v4:feci,v5:fecf},function(data1){
                $('#list').html(data1);
        });
...
function LoadData(){
    ...
    var fecf=$("#fec2").val();
        ...
        $.ajax({
                        ...
                        type: 'POST',
                        data: {modulo:4,accion:4,v:Grado,v1:selFec,v2:Asist,v3:selSec,v4:feci,v5:fecf},
