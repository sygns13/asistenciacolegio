...
window.open('impDetAlumnos.php?v='+selFec+'&v1='+feci+'&v2='+fecf+'&v3='+idper+'&v4='+dtos,' _blank');
...
$("#selFec").change(function() {
    ...
    if(selFec<4){
        ...
        $("#divfec").hide();
        $.post("../Funciones/Ajax.php",{modulo:4,accion:5,v:selFec,v1:feci,v2:fecf,v3:idper,v4:dtos},function(data1){
                $('#list').html(data1);
        });
...
function LoadData(){
    ...
    var fecf=$("#fec2").val();
        ...
        $.ajax({
                        ...
                        type: 'POST',
                        data: {modulo: '4', accion: '5',v:selFec,v1:feci,v2:fecf,v3:idper,v4:dtos},
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb" >
                    <div class="page-header pull-left">
                        ...
                        <div class="page-title">
                            Módulo de Reportes de Alumnos</div>
                ...
                while($row=mysql_fetch_array($res)){
                    ...
                    echo'<div class="panel-heading" >
                        Detalle de Asistencias: Alumno: '.$row[1].' '.$row[2].'    DNI: '.$row[3].'</div>
