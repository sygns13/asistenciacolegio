...
<html lang="es">
<head>
    <title>Gestión de Conceptos de Alumnos</title>
    <meta charset="utf-8">
...
$("#close").click(function(e){
           window.location= 'repAlumnos.php';
...
var idCon=$("#cbtipo").val();
          $.post("../Funciones/Ajax.php",{modulo:8,accion:5,v:idCon},function(data1){
                $('#cbconcepto').html(data1);
        });
...
window.open('impDetAlumnosCon.php?v='+selFec+'&v1='+feci+'&v2='+fecf+'&v3='+idper+'&v4='+dtos+'&v5='+ptos,' _blank');
...
$("#selFec").change(function() {
    ...
    if(selFec<3){
        ...
        $("#divfec").hide();
        $.post("../Funciones/Ajax.php",{modulo:8,accion:4,v:selFec,v1:feci,v2:fecf,v3:idper,v4:dtos},function(data1){
                $('#list').html(data1);
        });
...
$("#btnGuardar").click(function(e){
           ...
           if(idLista==0){
            ...
            if(obs.trim().length==0){
                ...
                swal('','Complete información en la observación','info');
            }
            else{

                $.post("../Funciones/ajax.php",{modulo:8,accion:6,v1:idPer,v2:idLista,v3:fec,v4:obs,v5:idUsu},function(data1){
           ...
           $.post("../Funciones/ajax.php",{modulo:8,accion:7,v1:idPer,v2:idLista,v3:fec,v4:obs,v5:idUsu},function(data1){

                $("#msj").html(data1);
               LoadData();
                $("#txtObs").val("");
                swal('','Exito, concepto registrado','success')
...
function LoadData(){
    ...
    var fecf=$("#fec2").val();
        ...
        $.ajax({
                        ...
                        type: 'POST',
                        data: {modulo: '8', accion: '4',v:selFec,v1:feci,v2:fecf,v3:idper,v4:dtos},
     ...
     function del(id,filtro,nom) {
         swal({
  title: "¿Está seguro?",
  text: "Se eliminará el Registro: "+nom,
  type: "warning",
...
function(){
  ...
  $.post("../Funciones/ajax.php",{modulo:8,accion:8,v1:id,v2:filtro},function(data1){
    ...
    <div>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb" >
                    <div class="page-header pull-left">
                        ...
                        <div class="page-title">
                            Módulo de Reportes de Alumnos - Recomendaciones, Tareas u Observaciones</div>

                        
                        </div>
                    <ol class="breadcrumb page-breadcrumb pull-right" id="idol">
                        <li><i class="fa fa-user"></i>&nbsp;<a href="reportes.php">Reportes</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="hidden"><a href="#">Reportes de Alumnos</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">Reportes de Alumnos</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                    ...
                    <div id="tab-general">
                        ...
                        <nav class="navbar navbar-inverse navbar-foxid" role="navigation" id="sacar1">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                <button type="button" class="btn btn-info btn-ms" id="newAlum"> <i class="fa fa-plus"></i> Nuevo</button>
                        ...
                        <div class="panel panel-default" id="PanewAlum">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                      <select id="cbtipo" class="form-control input-sm" autofocus  style="border: solid 1px;color: rgb(102, 101, 110);" >
                                        ...
                                        echo '<option value="5">OBSERVACIÓN GENERAL - O</option>';
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                        <select id="cbconcepto" class="form-control input-sm" autofocus  style="border: solid 1px;color: rgb(102, 101, 110);" >
                                       <?php

                                        $sql="select * from listaconcepto where idconcepto='1' and estado='Activo';";
                ...
                echo'<input type="text" id="fec" placeholder="dd/mm/aaaa" style="border: solid 1px;color: rgb(102, 101, 110);" class="form-control input-sm" onKeyPress="return noEscribe(event);" value="'.$fecha.'">';
                ...
                ?>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                        <textarea class="form-control input-sm"  id="txtObs" maxlength="450" style="border: solid 1px;color: rgb(102, 101, 110);">
                                         </textarea></div>
                                </div><br>
                ...
                echo'<input type="hidden" value="'.$idPer.'" id="idPer">';

                $sql="select * from persona where idpersona='".$idPer."';";
                ...
                while($row=mysql_fetch_array($res)){
                    ...
                    echo'<div class="panel-heading" >
                        Detalle de Recomendaciones, Tareas u Observaciones: Alumno: '.$row[1].' '.$row[2].'    DNI: '.$row[3].'</div>

                        <input type="hidden" value="Alumno: '.$row[1].' '.$row[2].'    DNI: '.$row[3].'" id="dtos">
                ...
                <option value="1" selected="true">Mes</option>
