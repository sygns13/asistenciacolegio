...
$("#close").click(function(e){
           window.location= 'repDocentes.php';
...
var dtos=$("#dtos").val();
    ...
    window.open('impDetDocentes.php?v='+selFec+'&v1='+feci+'&v2='+fecf+'&v3='+idper+'&v4='+dtos,' _blank');
});
...
$("#selFec").change(function() {
    ...
    if(selFec<4){
        ...
        $("#divfec").hide();
        $.post("../Funciones/Ajax.php",{modulo:4,accion:6,v:selFec,v1:feci,v2:fecf,v3:idper,v4:dtos},function(data1){
                $('#list').html(data1);
        });
...
function LoadData(){
    ...
    var fecf=$("#fec2").val();
        ...
        $.ajax({
                        ...
                        type: 'POST',
                        data: {modulo: '4', accion: '6',v:selFec,v1:feci,v2:fecf,v3:idper,v4:dtos},
            ...
            <div id="page-wrapper">
                ...
                while($row=mysql_fetch_array($res)){
                    ...
                    echo'<div class="panel-heading" >
                        Detalle de Asistencias: Docente: '.$row[1].' '.$row[2].'    DNI: '.$row[3].'</div>

                        <input type="hidden" value="Docente: '.$row[1].' '.$row[2].'    DNI: '.$row[3].'" id="dtos">
