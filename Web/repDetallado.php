...
$("#impRel").click(function(e){
    ...
    window.open('impDetallado.php?v='+Grado+'&v1='+selFec+'&v2='+per+'&v3='+selSec+'&v4='+feci+'&v5='+fecf,' _blank');
});
...
$("#selGra").change(function() {
    ...
    if(Grado==0){
        ...
        $("#divsec").hide();
        $.post("../Funciones/Ajax.php",{modulo:10,accion:1,v:Grado,v1:selFec,v2:per,v3:0,v4:feci,v5:fecf},function(data1){
                $('#list').html(data1);
        });
...
$("#selSec").change(function() {
    ...
    $.post("../Funciones/Ajax.php",{modulo:10,accion:1,v:Grado,v1:selFec,v2:per,v3:selSec,v4:feci,v5:fecf},function(data1){
                $('#list').html(data1);
        });
...
var Grado=parseInt($("#selGra").val());
 ...
 $.post("../Funciones/Ajax.php",{modulo:10,accion:0,v:Grado,v1:selFec,v2:per,v3:selSec,v4:feci,v5:fecf},function(data1){
                $('#list').html(data1);
        });
...
function LoadData(){
    ...
    var fecf=$("#fec2").val();
        ...
        $.ajax({
                        ...
                        type: 'POST',
                        data: {modulo:10,accion:1,v:Grado,v1:selFec,v2:per,v3:selSec,v4:feci,v5:fecf},
    ...
    <div>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb" >
                    <div class="page-header pull-left">
                        <div class="page-title">
                            Módulo de Reportes Económicos Detallados</div>
                            
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right" id="idol">
                        <li><i class="fa fa-area-chart"></i>&nbsp;<a href="reportesE.php">Reportes</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="hidden"><a href="#">Reportes Económicos Detallados</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">Reportes Económicos Detallados</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                ...
                echo'Desde: <input type="text" id="fec1" readonly placeholder="dd/mm/aaaa" style="display: inline-block;
                    height: 34px;font-size: 12px;line-height: 1.5; width: 27%;" onKeyPress="return noEscribe(event);" value="'.$fecha.'">
                    Hasta: <input type="text" id="fec2" readonly placeholder="dd/mm/aaaa" style=" display: inline-block;
                    height: 34px;font-size: 12px;line-height: 1.5; width: 27%;" onKeyPress="return noEscribe(event);" value="'.$fecha.'">';
