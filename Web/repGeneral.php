...
$("#impRel").click(function(e){
    ...
    window.open('impGeneral.php?v='+Grado+'&v1='+selFec+'&v2='+per+'&v3='+selSec+'&v4='+feci+'&v5='+fecf,' _blank');
});
...
$("#selGra").change(function() {
    ...
    if(Grado==0){
        ...
        $("#divsec").hide();
        $.post("../Funciones/Ajax.php",{modulo:10,accion:0,v:Grado,v1:selFec,v2:per,v3:0,v4:feci,v5:fecf},function(data1){
                $('#list').html(data1);
        });
...
function LoadData(){
    ...
    var fecf=$("#fec2").val();
        ...
        $.ajax({
                        ...
                        type: 'POST',
                        data: {modulo:10,accion:0,v:Grado,v1:selFec,v2:per,v3:selSec,v4:feci,v5:fecf},
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb" >
                    <div class="page-header pull-left">
                        <div class="page-title">
                            Módulo de Reportes Económicos Generales</div>
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right" id="idol">
                        ...
                        <li class="hidden"><a href="#">Reportes Económicos Generales</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">Reportes Económicos Generales</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
