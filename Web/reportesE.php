...
<html lang="es">
<head>
    <title>Reportes Económicos</title>
    <meta charset="utf-8">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">
                            Módulo de Reportes Económicos</div>
                            
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-bar-chart"></i>&nbsp;<a href="reportesE.php">Reportes</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="hidden"><a href="#">Reportes</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">Reportes Económicos</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                                ...
                                <div class="panel profit db mbm">
                                    <div class="panel-body">
                                        ...
                                        <h4 class="value">
                                            ...
                                            </span><span style="font-size: 20px;">R. Generales</span></h4>
                                        <p class="description">
                                            Ingrese Aqui</p>
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="panel profit db mbm">
                                    <div class="panel-body">
                                        ...
                                        <h4 class="value">
                                            <span data-counter="" data-start="10" data-end="50" data-step="1" data-duration="0">
                                            </span><span style="font-size: 20px;">R. Detallados</span></h4>
                                        <p class="description">
                                            Ingrese Aqui</p>
                                        <div class="progress progress-sm mbn">
                                            <div role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="panel profit db mbm">
                                    <div class="panel-body">
                                        ...
                                        <h4 class="value">
                                            <span data-counter="" data-start="10" data-end="50" data-step="1" data-duration="0">
                                            </span><span style="font-size: 20px;">Deudas</span></h4>
                                        <p class="description">
                                            Ingrese Aqui</p>
                                        <div class="progress progress-sm mbn">
                                            <div role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"
