...
<head>
    ...
    $(document).ready(function() {
        ...
        jQuery("#delete").click(function() {
            ...
            var item= new Array();
                         var cont=0;
                        $(jQuery("#idcat:checked").each(function(){
                        item.push($(this).val());
                        cont=cont+1;
                        }));
                        if (cont==0){
                            alert("Seleccione al menos una categoría");
                                ...
                                if (confirm("Realmente desea eliminar la categoría(s) Seleccionados")){
                        ...
                        success: function(data) {
                         ...
                         $.each(item,function(index,contenido){
                            ...
                            url: 'Ajax/Ajax.php',
                            type: 'POST',
                            data: {idcat: (contenido), module: '1', action: '1'},
                            success: function(data) {
                                           LoadData();             
                                },
        ...
        jQuery("#new").click(function(){
            if(jQuery("#cat").val().length>0){

                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {cat: jQuery("#cat").val(), module: '1', action: '2'},
                        success: function(data) {
                            $('#msj').html(data);
                            limpiar();
            ...
            {
                alert("Llene el nombre de una categoría nueva en la caja de texto Descripción");
            }
        }); 
            ...
            var item= new Array();
                        ...
                        if (aux==1){
                            $.each(item,function(index,contenido){
                                ...
                                url: 'Ajax/Ajax.php',
                                type: 'POST',
                                data: {id: jQuery("#id").val(), module: '1', action: '3'},
                                success: function(data) {
                                    //$('#tabla').html(data);
                                    $("#inp").html(data);
                                    $("#edit").hide();
         ...
         jQuery("#edit2").click(function(){
            if(jQuery("#cat").val().length>0){
                 ...
                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {cat: jQuery("#cat").val(), id: jQuery("#id").val(), module: '1', action: '4'},
                        success: function(data) {
                            $('#msj').html(data);
                            limpiar();
            ...
            {
                alert("Llene el nombre nuevo de la categoría en la caja de texto Descripción");
            }
        }); 
    ...
    function LoadData() {
                    $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {search: jQuery("#inputsearch").val(), module: '1', action: '0'},
                        success: function(data) {
                            $('#tabla').html(data);
                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Mantenimiento de Categorías</div>
                            <div class="panel-body">
                                
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Descripci&oacuten:</label>
                                    <div class="col-lg-5" id="inp">
                                        <input type="text" class="form-control input-sm" style="border: solid 1px;color: rgb(102, 101, 110);" id="cat" name="cat">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">Catalogo de Categorías</div>
                            <div class="panel-body">
                                <div class="col-lg-6">
