    ...
    <div>
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="index.html" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">GYD CONS</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
            <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle"><img src="images/avatar/48.jpg" alt="" class="img-responsive img-circle"/>&nbsp;<span class="hidden-xs">Administrador</span>&nbsp;<span class="caret"></span></a>
                        <ul class="dropdown-menu dropdown-user pull-right">
                            <li><a href="#"><i class="fa fa-user"></i>Mi Perfil</a></li>
                        
                            <li><a href="Login.html"><i class="fa fa-key"></i>Cerrar Session</a></li>
                        </ul>
                    </li>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                ...
                echo'<ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="categorias.php"><i class="fa fa-archive">
                    ...
                    <div id="tab-general">
                        ...
                        <nav class="navbar navbar-inverse navbar-foxid" role="navigation">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                <button type="button" class="btn btn-primary btn-ms" id="new"> <i class="fa fa-floppy-o"></i> Nuevo</button>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm" id="producto" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Ruc:</label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm" id="stockmin" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Direccion:</label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm" id="stockmax" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                                 <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Telefono:</label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm" id="stockreal" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Catalogo de Clientes</div>
                            <div class="panel-body">
                                <div class="col-lg-6">
                            ...
                            <div class="panel-body">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="active">Empresa 1</td>
                                        <td class="active">15923654785</td>
                                        <td class="active">Av. Trinitarias 345</td>
                                        <td class="active">425895</td>
