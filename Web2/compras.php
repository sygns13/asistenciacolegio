    ...
    var tot=0;
     ...
     $(document).ready(function() { 
        ...
        jQuery("#cancel").click(function() {
         ...
         jQuery("#neoP").click(function() {
            //window.location = "Productos.php";
            window.open('Productos.php','_blank');
        });
            ...
            var item= new Array();
                        ...
                        if (cont==0){
                            ...
                            $.each(item,function(index,contenido){
                                ...
                                url: 'Ajax/Ajax.php',
                                type: 'POST',
                                data: {idprod: (contenido), module: '8', action: '2'},
                                ...
                                complete: function(){
                                     ...
                                     var num1=parseFloat(jQuery("#cos"+cod).val());
                                     var num2=parseInt(jQuery("#ca"+cod).val());
                                     num3=num1*num2;
                                if ($('#fil'+cod).length){
                                    ...
                                    if(num1>0 && num2>0){
                                    $('#table2 tr:last').after('<tr id="fil'+cod+'"><td ><input class="idlist"  type="checkbox" name="idlistP[]" id="idlistP" value="'+
                                        jQuery("#codProd").val()+'"/></td><td>'+jQuery("#nomProd").val()+'</td><td>'+jQuery("#marProd").val()+'</td><td>'+
                                        num2+' <input type="hidden" value="'+num2+'" id="cant'+cod+'"></td><td>'+
                                        num1+' <input type="hidden" value="'+num1+'" id="cosu'+cod+'"></td><td>'+
                                        num3+' <input type="hidden" value="'+num3+'" id="cost'+cod+'" class="totail"></td></tr>');
            ...
            var item= new Array();
                        ...
                        if (cont==0){
                            alert("Seleccione al menos un Producto");
                                ...
                                $.each(item,function(index,contenido){
                            //alert(contenido);
                            num2=parseFloat(jQuery("#cost"+contenido).val());    
        ...
        jQuery("#new").click(function(){
            ...
            if(jQuery("#prov").val()>0 && jQuery("#fecha").val().length>0 && jQuery("#orden").val().length>0 && num>0){

                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {prov: jQuery("#prov").val(), fecha: jQuery("#fecha").val(), orden: jQuery("#orden").val() , cost: jQuery("#total").val(), module: '8', action: '3'},
                        success: function(data) {
                            $('#msj').html(data);
                            limpiar();
                            LoadData2();
                        ...
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {idprod: contenido, idCom: jQuery("#idCompra").val(), cant: jQuery("#cant"+contenido).val() , cosu: jQuery("#cosu"+contenido).val(), module: '8', action: '4'},
                        success: function(data) {
                            LoadData();
            ...
            {
                alert("Complete Toda la Información de la Compra de Productos");
            } 
            }); 
     ...
     function LoadData() {
                    $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {search: jQuery("#inputsearch").val(), module: '8', action: '0'},
                        success: function(data) {
                            $('#table').html(data);
               ...
               <?php
                echo'<ul id="side-menu" class="nav">
                  ...
                  if($_SESSION['nivel']==1 || $_SESSION['nivel']==2){
                    ...
                    <li class="active"><a href="compras.php"><i class="fa fa-usd">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="#">Compras</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Mantenimiento de Compras</div>
                            <div class="panel-body">
                          
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Proveedor:</label>
                                    <div class="col-lg-5"><select id="prov" class="form-control" style="border: solid 1px;color: rgb(102, 101, 110);">
                                ...
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Num. Orden de Compra:</label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm" id="orden" placeholder="Número" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                               ...
                               <div id="table"></div>
                                ...
                                <button type="button" class="btn btn-primary btn-ms" id="agregar"> <i class="fa fa-floppy-o"></i> Agregar Producto a la Lista de Compra</button>
                                <button type="button" class="btn btn-warning btn-ms" id ="neoP"><i class="fa fa-list-alt"></i> Nuevo Producto</button>
                            </div>
                            </div>
                        </div>
                     ...
                     <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                               ...
                               <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm" disabled="true" placeholder="00.00" id="total" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div>
                                
                               <button type="button" class="btn btn-danger btn-ms" id="deleteC"><i class="fa fa-eraser"></i> Quitar de la Lista</button>
