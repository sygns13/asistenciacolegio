...
<head>
    ...
    $(document).ready(function() { 
        ...
        jQuery("#agregar").click(function() {
            ...
            var item= new Array();
                        ...
                        if (cont==0){
                            ...
                            $.each(item,function(index,contenido){
                                ...
                                url: 'Ajax/Ajax.php',
                                type: 'POST',
                                data: {idprod: (contenido), module: '5', action: '2'},
                                ...
                                if ($('#fil'+cod).length){
                                    ...
                                    //alert(jQuery("#cos"+cod).val()+' '+jQuery("#cantProd").val() );                                                                                                                                                                                                                                                        
                                        ...
                                        alert("Ingresó una cantidad inapropiada o mayor al stock en el producto "+$('#nomProd').val());
            ...
            if(jQuery("#proy").val()>0 && jQuery("#estado").val().length>0 && jQuery("#fecha").val().length>0 && jQuery("#orden").val().length>0 && num>0){

                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {proy: jQuery("#proy").val(), estado: jQuery("#estado").val(), fecha: jQuery("#fecha").val(), orden: jQuery("#orden").val(), module: '5', action: '3'},
                        success: function(data) {
                            $('#msj').html(data);
                            limpiar();
                            LoadData2();
                        ...
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {idprod: contenido, idPed: jQuery("#idPedido").val(), cant: jQuery("#cant"+contenido).val(), module: '5', action: '4'},
                        success: function(data) {
                            LoadData();
            ...
            {
                alert("Complete Toda la Información de un Despacho de Productos");
            } 
            }); 
    ...
    function LoadData() {
                    $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {search: jQuery("#inputsearch").val(), module: '5', action: '0'},
                        success: function(data) {
                            $('#table').html(data);
            ...
            <div class="sidebar-collapse menu-scroll">
                ...
                echo'<ul id="side-menu" class="nav">
                  ...
                  if($_SESSION['nivel']==1 || $_SESSION['nivel']==2){
                    ...
                    <li class="active"><a href="despachos.php"><i class="fa fa-truck">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="#">Despachos</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Mantenimiento de Despachos de Productos a un Proyecto</div>
                            <div class="panel-body">
                                ...
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">N° de Orden de Despacho:</label>
                                    <div class="col-lg-5">
                               ...
                               <button type="button" class="btn btn-primary btn-ms" id="agregar"> <i class="fa fa-floppy-o"></i> Agregar Producto a la Lista de Despacho</button>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">Lista de Despacho</div>
                            <div class="panel-body">
                               <div id="table2"></div>
                               <button type="button" class="btn btn-danger btn-ms" id="deleteP"><i class="fa fa-eraser"></i> Quitar de la Lista</button>
