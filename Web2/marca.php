...
<head>
    ...
    $(document).ready(function() {
        ...
        jQuery("#delete").click(function() {
            ...
            var item= new Array();
                         var cont=0;
                        $(jQuery("#idmarca:checked").each(function(){
                        item.push($(this).val());
                        cont=cont+1;
                        }));
                        if (cont==0){
                            alert("Seleccione al menos una marca");
                        }
                            else{

                                if (confirm("Realmente desea eliminar la marca(s) Seleccionados")){

                                    $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {search: jQuery("#inputsearch").val(), module: '0', action: '-1'},
                        success: function(data) {
                         ...
                         $.each(item,function(index,contenido){
                            ...
                            url: 'Ajax/Ajax.php',
                            type: 'POST',
                            data: {idmarca: (contenido), module: '0', action: '1'},
                            success: function(data) {
                                              LoadData();          
                                },
        ...
        jQuery("#new").click(function(){
            if(jQuery("#marca").val().length>0){

                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {marca: jQuery("#marca").val(), module: '0', action: '2'},
                        success: function(data) {
                            $('#msj').html(data);
                            limpiar();
            ...
            {
                alert("Llene el nombre de una marca nueva en la caja de texto Descripción");
            }
        }); 
            ...
            var item= new Array();
                        ...
                        if (aux==1){
                            $.each(item,function(index,contenido){
                                ...
                                url: 'Ajax/Ajax.php',
                                type: 'POST',
                                data: {id: jQuery("#id").val(), module: '0', action: '3'},
                                success: function(data) {
                                    //$('#tabla').html(data);
                                    $("#inp").html(data);
                                    $("#edit").hide();
         ...
         jQuery("#edit2").click(function(){
            if(jQuery("#marca").val().length>0){
                 ...
                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {marca: jQuery("#marca").val(), id: jQuery("#id").val(), module: '0', action: '4'},
                        success: function(data) {
                            $('#msj').html(data);
                            limpiar();
            ...
            {
                alert("Llene el nombre nuevo de la marca en la caja de texto Descripción");
            }
        }); 
    ...
    function LoadData() {
                    $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {search: jQuery("#inputsearch").val(), module: '0', action: '0'},
                        success: function(data) {
                            $('#tabla').html(data);
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                ...
                echo'<ul id="side-menu" class="nav">
                    ...
                    <li class="active" ><a href="marca.php"><i class="fa fa-buysellads">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="#">Marcas</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Mantenimiento de Marcas</div>
                            <div class="panel-body">
                                <div id="msj"></div>
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Descripci&oacuten:</label>
                                    <div class="col-lg-5" id="inp">
                                        <input type="text" class="form-control input-sm" style="border: solid 1px;color: rgb(102, 101, 110);" id="marca" name="marca">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">Catalogo de Marcas</div>
                            <div class="panel-body">
                                <div class="col-lg-6">
