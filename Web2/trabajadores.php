...
session_start();
if(!isset($_SESSION['user'])||($_SESSION['nivel']<1) ||($_SESSION['nivel']>2)){
...
<head>
    ...
    $(document).ready(function() {
        ...
        jQuery("#delete").click(function() {
            ...
            var item= new Array();
                         var cont=0;
                        $(jQuery("#idtrab:checked").each(function(){
                        item.push($(this).val());
                        cont=cont+1;
                        }));
                        if (cont==0){
                            alert("Seleccione al menos un Trabajador");
                                ...
                                if (confirm("Realmente desea eliminar al Trabajador(es) Seleccionados")){
                        ...
                        success: function(data) {
                         ...
                         $.each(item,function(index,contenido){
                            ...
                            url: 'Ajax/Ajax.php',
                            type: 'POST',
                            data: {idtrab: (contenido), module: '3', action: '2'},
                            success: function(data) {
                                           LoadData();             
                                },
        ...
        jQuery("#new").click(function(){
            if(jQuery("#nombres").val().length>0 && jQuery("#ape").val().length>0 && jQuery("#dni").val().length>0 && jQuery("#dir").val().length>0 && jQuery("#cargo").val()>0){

                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {nombre: jQuery("#nombres").val(), ape: jQuery("#ape").val(), dni: jQuery("#dni").val(),dir: jQuery("#dir").val(), telf: jQuery("#telf").val(), cargo: jQuery("#cargo").val(), module: '3', action: '3'},
                        success: function(data) {
                            $('#msj').html(data);
                            limpiar();
            ...
            var item= new Array();
                        ...
                        if (aux==1){
                            $.each(item,function(index,contenido){
                                ...
                                url: 'Ajax/Ajax.php',
                                type: 'POST',
                                data: {id: jQuery("#id").val(), module: '3', action: '4'},
                                success: function(data) {
                                    //$('#tabla').html(data);
                                    $("#formu").html(data);
                                    $("#edit").hide();
        ...
        jQuery("#edit2").click(function(){
            if(jQuery("#nombres").val().length>0 && jQuery("#ape").val().length>0 && jQuery("#dni").val().length>0 && jQuery("#dir").val().length>0 && jQuery("#cargo").val()>0){
                 ...
                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {id: jQuery("#id").val(), nombre: jQuery("#nombres").val(), ape: jQuery("#ape").val(), dni: jQuery("#dni").val(),dir: jQuery("#dir").val(), telf: jQuery("#telf").val(), cargo: jQuery("#cargo").val(), module: '3', action: '5'},
                        success: function(data) {
                            $('#msj').html(data);
                            limpiar();
        ...
        jQuery("#grabC").click(function(){
            if(jQuery("#nomcar").val().length>0){

                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {cargo: jQuery("#nomcar").val(), module: '3', action: '7'},
                        success: function(data) {
                            $('#msj2').html(data);
                            limpiar2();
            ...
            {
                alert("Llene el nombre de un cargo nuevo en la caja de texto Descripción");
            }
        }); 


        jQuery("#deleteC").click(function() {
            

            var item= new Array();
                         var cont=0;
                        $(jQuery("#idca:checked").each(function(){
                        item.push($(this).val());
                        cont=cont+1;
                        }));
                        if (cont==0){
                            alert("Seleccione al menos un cargo");
                                ...
                                if (confirm("Realmente desea eliminar el cargo(s) Seleccionados")){

                                    $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {search: jQuery("#inputsearch").val(), module: '1', action: '-1'},
                        success: function(data) {
                         ...
                         $.each(item,function(index,contenido){
                            ...
                            url: 'Ajax/Ajax.php',
                            type: 'POST',
                            data: {idca: (contenido), module: '3', action: '8'},
                            success: function(data) {
                                           LoadData2(); limpiar2();            
                                },
    ...
    function LoadData() {
                    $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {search: jQuery("#inputsearch").val(), module: '3', action: '0'},
                        success: function(data) {
                            $('#tabla').html(data);
    ...
    function LoadData2() {
                    $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {search: jQuery("#inputsearch").val(), module: '3', action: '6'},
                        success: function(data) {
                            $('#table2').html(data);
            ...
            <div class="sidebar-collapse menu-scroll">
                ...
                echo'<ul id="side-menu" class="nav">
                  ...
                  if($_SESSION['nivel']==1 || $_SESSION['nivel']==2){
                    echo '<li class="active"><a href="trabajadores.php"><i class="fa fa-users">
                        <div class="icon-bg bg-green"></div>
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="#">Trabajadores</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                    ...
                    <div id="tab-general">
                        ...
                        <nav class="navbar navbar-inverse navbar-foxid" role="navigation">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                               ...
                               <a data-toggle="modal" data-target="#myModal"> <button type="button" class="btn btn-warning btn-ms" id ="ncargo"><i class="fa fa-list-alt"></i> Gestionar Cargos</button></a>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Mantenimiento del Trabajador</div>
                            <div class="panel-body">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm" id="nombres" placeholder="Nombres" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Apellidos:</label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm" id="ape" placeholder="Apellidos" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">DNI:</label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm" id="dni" placeholder="DNI" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Catalogo de Trabajadores</div>
                            <div class="panel-body">
                                <div class="col-lg-6">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">
                                Mantenimiento de Cargos</h4>
                        </div>
                        <div class="modal-body">
                            <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Descripción:</label>
                                    <div class="col-lg-5">
                                        <input placeholder="Cargo" id="nomcar" type="text" class="form-control input-sm" id="producto" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                                

                                <br><br>
                               <button type="button" class="btn btn-primary btn-ms" id="grabC"> <i class="fa fa-floppy-o"></i> Guardar</button>
                                <button type="button" class="btn btn-danger btn-ms" id="deleteC"><i class="fa fa-eraser"></i> Eliminar</button>
