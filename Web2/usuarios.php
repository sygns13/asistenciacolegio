...
session_start();
if(!isset($_SESSION['user'])||($_SESSION['nivel']>1) ||($_SESSION['nivel']<1)){
...
<head>
    ...
    $(document).ready(function() {
        ...
        jQuery("#new").click(function(){
            if(jQuery("#trab").val()>0 && jQuery("#nivel").val()>0 && jQuery("#usu").val().length>0 && jQuery("#clave").val().length>0){

                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {trab: jQuery("#trab").val(), nivel: jQuery("#nivel").val(), usu: jQuery("#usu").val(), clave: jQuery("#clave").val(), module: '9', action: '1'},
        ...
        jQuery("#delete").click(function() {
            ...
            var item= new Array();
                         var cont=0;
                        $(jQuery("#idusu:checked").each(function(){
                        item.push($(this).val());
                        cont=cont+1;
                        }));
                        if (cont==0){
                            alert("Seleccione al menos un Usuario");
                                ...
                                if (confirm("Realmente desea eliminar el Usuario(s) Seleccionados")){
                        ...
                        success: function(data) {
                         ...
                         $.each(item,function(index,contenido){
                            ...
                            if(contenido==2){
                            alert("El SuperAdministrador no se Puede eliminar!");
                            ...
                            url: 'Ajax/Ajax.php',
                            type: 'POST',
                            data: {idusu: (contenido), module: '9', action: '3'},
                            success: function(data) {
                                           LoadData();   
                                           $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {search: jQuery("#inputsearch").val(), module: '9', action: '2'},
                        success: function(data) {
                            $('#cboT').html(data);
        ...
        jQuery("#edit").click(function(){
            var item= new Array();
                        ...
                        if (aux==0){
                            ...
                            alert("Seleccione una alternativa a editar la Contraseña");
                        ...
                        if (aux>1){
                            alert("Solo seleccione una alternativa a editar la Contraseña");
                            window.reload();
                        ...
                        if (aux==1){
                            $.each(item,function(index,contenido){
                               ...
                               $.ajax({
                                url: 'Ajax/Ajax.php',
                                type: 'POST',
                                data: {id: jQuery("#id").val(), module: '9', action: '4'},
                                success: function(data) {
                                    $('#userC').html(data);
                                    $('#myModal').modal('show');
    ...
    jQuery("#grabU").click(function(){
            if(jQuery("#clave1").val().length>0 && jQuery("#clave2").val().length>0 && jQuery("#clave1").val()==jQuery("#clave2").val()){

                 $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {clave: jQuery("#clave1").val(), id: jQuery("#id").val(), module: '9', action: '5'},
                        success: function(data) {
                            $('#msj2').html(data);
                            jQuery("#clave1").val("");
                             jQuery("#clave2").val("");
            ...
            {
                alert("Complete Correctamente las claves");
            }
        });
    ...
    function LoadData() {
                    $.ajax({
                        url: 'Ajax/Ajax.php',
                        type: 'POST',
                        data: {search: jQuery("#inputsearch").val(), module: '9', action: '0'},
                        success: function(data) {
                            $('#tabla').html(data);
                    ...
                    <div id="tab-general">
                        ...
                        <nav class="navbar navbar-inverse navbar-foxid" role="navigation">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                               ...
                               <button type="button" class="btn btn-success  btn-ms" id="edit"><i class="fa fa-pencil-square-o"></i> Editar Contraseña</button> 
                                <button type="button" class="btn btn-success  btn-ms" id="edit2"><i class="fa fa-pencil-square-o"></i> Grabar Contraseña</button>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Mantenimiento del Usuarios del Sistema</div>
                            <div class="panel-body">
                                <div id="msj"></div>
                                  ...
                                  <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5" id="cboT"><select id="trab" class="form-control" style="border: solid 1px;color: rgb(102, 101, 110);">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5"><select id="nivel" class="form-control" style="border: solid 1px;color: rgb(102, 101, 110);">
                                        <option value="0">Seleccione...</option>
                            ...
                            <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control input-sm" id="usu" placeholder="Username" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Password:</label>
                                    <div class="col-lg-5">
                                        <input type="password" class="form-control input-sm" id="clave" placeholder="*******" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">
                                Cambiar Contraseña</h4></div>
                        </div>
                        <div class="modal-body">
                            <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Nueva Contraseña:</label>
                                    <div class="col-lg-5">
                                        <input placeholder="*****" id="clave1" type="password" class="form-control input-sm" id="producto" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br> <br>
                                <div class="form-group form-group-sm">
                                    <label class="col-lg-2 control-label">Repetir Contraseña:</label>
                                    <div class="col-lg-5">
                                        <input placeholder="*****" id="clave2" type="password" class="form-control input-sm" id="producto" style="border: solid 1px;color: rgb(102, 101, 110);">
                                    </div>
                                </div><br>
