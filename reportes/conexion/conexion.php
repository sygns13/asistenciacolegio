<?php 
		class Conexion{
			...
			function Conexion(){
				...
				$this->contrasena="13111991"; //contraseña que tengas definidad
				$this->baseDatos="bdexistenciaproductos"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
			}
			...
			function conectarse(){		
				...
				$enlace = mysqli_connect($this->ruta, $this->usuario, '13111991', $this->baseDatos);
				if($enlace){
